...
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n' 
            + 'FN:✧͜͡҉ ঔৣ͜͡𝐇͢𝐈𝐃͢𝐑𝚫 𝚯𝐅 ͢𝚩𝚫͢𝐍💸⃟ꦿ⸼\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `𝙊𝙡𝙖́ 「 @${num.split('@')[0]} 」\n𝘽𝙚𝙢 𝙫𝙞𝙣𝙙𝙤 𝙖𝙤 𝙜𝙧𝙪𝙥𝙤:\n━━❰･ *${mdata.subject}* ･❱━━\n\n𝙋𝙤𝙧 𝙛𝙖𝙫𝙤𝙧 𝙡𝙚𝙞𝙖 𝙖𝙨 𝙧𝙚𝙜𝙧𝙖𝙨\n𝙀 𝙨𝙚𝙟𝙖 𝙛𝙚𝙡𝙞𝙯 𝙣𝙤 𝙜𝙧𝙪𝙥𝙤🤝\n*Para ter acesso ao bot envie /menu*`
				...
				teks = `𝙁𝙡𝙬 @${num.split('@')[0]} não via a hora de você sair🥱`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["556796005372@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"556796005372@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["556796005372@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["556796005372@s.whatsapp.net"]//ubah nomor lo
			const premium = ["556796005372@s.whatsapp.net","5527997235985@s.whatsapp.net","556281212020@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		if (messagesC.includes("#izinadmin")) return reply("#izinadmin diterima")
		var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		reply(`link detectado ${sender.split("@")[0]} voce sera expulso deste grupo imediatamente`)
		setTimeout( () => {
			client.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		}, 1000)
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("Seu grupo será visitado com rajadas de link")
		}, 0)
	}
	...
	if (messagesC.includes("vsfd")){
		...
		if (messagesC.includes("corno")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/corno.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
            ...
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
				...
				if (messagesC.includes("macacomaca")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/macacomaca.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
			...
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/burra.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
				if (messagesC.includes("macaco")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/macaco.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
			...
			if (messagesC.includes("tetorara")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/tetorara.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
            ...
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
				...
				if (messagesC.includes("maedorafa")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/maedorafa.jpg');
            client.sendMessage(from, tujuh, MessageType.image, {quoted: mek, mimetype: 'image/jpg', ptt:true})
	}
...
// recursos anime, random @hidra domina vida
          ...
          reply('Espere..')
			    ...
			    case 'dono':
                    ...
                    buffer = await getBuffer(`https://i.ibb.co/PFQF6MB/hidraowmner.jpg`)
                    client.sendMessage(from, buffer, image, {quoted: mek, caption: '         「✧͜͡҉ ঔৣ͜͡𝐇͢𝐈𝐃͢𝐑𝚫 𝚯𝐅 ͢𝚩𝚫͢𝐍💸⃟ꦿ⸼ 」       \n*YOUTUBE:* Tem não\n*WPP:* wa.me/+556796005372\n*\n\nEspero que tenham gostado do bot️'})
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
